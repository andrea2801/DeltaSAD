                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row dni_login">
                                ...
                                <div class="col-md-10">
                                    <input id="dni_input_login" type="text" class="form-control @error('dni') is-invalid @enderror" name="dni" required autocomplete="dni" autofocus placeholder="Inserte su DNI">
                                    @error('dni')
                            ...
                            <div class="form-group row password_login">
                                ...
                                <div class="col-md-10">
                                    <input id="password_input_login" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Inserte su contraseña">
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
