            ...
            @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                        <input name="nombre" type="text" value="{{old('nombre')}}" class="form-control" id="inputNombre" placeholder="" required>
                        </div>
                        <label for="inputApellido" class="col-sm-2 col-form-label">Apellidos:</label>
                        <div class="col-sm-4">
                        <input name="apellidos" type="text" value="{{old('apellidos')}}" class="form-control" id="inputApellido" placeholder="" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                        <input name="password" type="password" class="form-control" value="{{old('password')}}" autocomplete="new-password" id="inputPassword" placeholder="" required>
