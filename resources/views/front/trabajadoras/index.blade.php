          ...
          <div class="col ml-5">
            ...
            <ul class="nav justify-content-end">
                  ...
                  <li class="nav-items border-left">
                    <a class="nav-link active" href="{{route('trabajadoras.todas')}}"><h2>Buscar</h2></a>
                  </li>
  ...
  <div class="card-deck">
    ...
    <div class="card text-center" style="width: 18rem;">
            ...
            <div>
                ...
                <a href="#" onclick="usuarios({{$tf->id}})" class="card-link" data-toggle="modal" data-target="#usuario" >Usuarios</a>
            </div>
